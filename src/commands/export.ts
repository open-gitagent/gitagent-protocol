...
export const exportCommand = new Command('export')
  ...
  .requiredOption('-f, --format <format>', 'Export format (system-prompt, claude-code, openai, crewai, openclaw, nanobot, lyzr, github, copilot, opencode, cursor, gemini, codex, langgraph)')
    ...
    try {
      ...
      switch (options.format) {
        ...
        default:
          ...
          info('Supported formats: system-prompt, claude-code, openai, crewai, openclaw, nanobot, lyzr, github, copilot, opencode, cursor, gemini, codex, langgraph');
          process.exit(1);
      }
