...
export const runCommand = new Command('run')
  ...
  .option('-a, --adapter <name>', 'Adapter: claude, openai, crewai, openclaw, nanobot, lyzr, github, opencode, gemini, codex, langgraph, git, prompt', 'claude')
    ...
    try {
      switch (options.adapter) {
        ...
        default:
          ...
          info('Supported adapters: claude, openai, crewai, openclaw, nanobot, lyzr, github, opencode, gemini, codex, langgraph, git, prompt');
          process.exit(1);
      }
    } catch (e) {
